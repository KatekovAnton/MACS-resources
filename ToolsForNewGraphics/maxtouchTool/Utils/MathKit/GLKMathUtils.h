...
extern "C" {
    ...
    static __inline__ float GLKMathDegreesToRadians(float degrees) { return degrees * (M_PI / 180.0f); };
    static __inline__ float GLKMathRadiansToDegrees(float radians) { return radians * (180.0f / M_PI); };
